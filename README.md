...
# Example:
     ...
     */
    @CatchAll
    public void catchAll(HttpRequest request){
    ...
    public void getIndex(HttpRequest request, @Param String name, @Param Integer age){
    ...
    public void getIndex(HttpRequest request, @Param JSONObject json){
        try {
    ...
    public void getRest3(HttpRequest request)  {
    ...
    @API
    @POST(path="/cors", response="text/text")
    public void getCORS(HttpRequest request, @Param JSONObject json){
            String response = "Hello " + json.toString();
            request.getResponse().ok(response).send();
    }
...
<img src="https://c8soft.se/ronah/apiimg2.png"/>
